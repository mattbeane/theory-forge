---
name: create-agent
description: Help the researcher design and build a bespoke analytical agent tailored to their specific project, data, and researc...
---
...
this skill lets researchers create project-specific agents that:
...
3. Output agent file to `.claude/skills/[agent-name].md` (flat directory — Claude Code discovers commands here)
...
1. Write the agent file to `.claude/skills/[agent-name].md`
...
```
.claude/skills/[agent-name].md
```

Custom agents live alongside core skills in `.claude/skills/`. To distinguish them:
...
Tell the user:
- The agent has been created at `.claude/skills/[agent-name].md`
