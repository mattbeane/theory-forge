...
description: Help users configure statistical consensus settings for their paper mining project
---
...
To run a single eval without consensus: append `--quick` to any eval skill
