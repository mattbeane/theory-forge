---
name: eval-paper-quality
description: Evaluate a draft paper using the paper_quality rubric with rubric-eval
---
...
This is complementary to `/eval-zuckerman` which focuses on framing. this skill focuses on overall execution quality.
...
this skill requires rubric-eval. Check if installed:
```bash
which rubric-eval
```
