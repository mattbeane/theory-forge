---
name: surface-absences
description: Identify what is conspicuously NOT present in the data — omissions, silences, and missing elements that may be analyt...
---
...
2. this skill can run at ANY point after `/explore-data` — it does not require theory or lens work
