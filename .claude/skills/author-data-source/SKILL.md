---
name: author-data-source
description: Help a contributor add support for a new qualitative or quantitative data format to theory-forge
---
...
Instead of trying to support everything centrally, this skill lets anyone add support for a new data source. The result is:
...
For contributing improvements upstream, see [contributing.md](contributing.md)
