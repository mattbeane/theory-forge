---
name: review-diff
description: Generate an interactive HTML diff viewer that lets the author review AI-proposed changes to their manuscript with ful...
---
...
this skill does not modify `state.json`. It is a pure read/review tool.
