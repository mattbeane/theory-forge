---
name: style-engine
description: Generate and evaluate multiple theoretical framings for the paper — rendering the same empirical reality through diff...
---
...
Interpreting the same data through multiple theoretical frames is a standard move in qualitative research. this skill accelerates it: systematically generating framings, evaluating each on multiple dimensions, and checking each adversarially — work that's valuable but laborious by hand.
