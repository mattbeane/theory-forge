---
name: build-lit-review
description: Take the identified theory and sensitizing literature and help the researcher build a targeted bibliography—finding s...
---
...
this skill bridges from "I need to engage Person-Environment Fit theory" to "Here are the 15-20 papers you should read and cite."
...
**AI cannot guarantee completeness**: Literature search is inherently incomplete. this skill provides a solid starting point but shouldn't replace:
...
**AI may hallucinate citations**: While this skill tries to identify real papers, always verify that papers actually exist before citing them. Check titles, authors, and years against actual databases.
