---
name: compare-frames
description: Systematically compare multiple theoretical framings of the same finding, helping researchers choose the strongest frame
---
...
this skill creates that comparison, evaluating each frame against multiple criteria to recommend the best option.
...
For the detailed dimension analysis template, see [dimension-analysis.md](dimension-analysis.md)
